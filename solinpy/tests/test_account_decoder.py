...
class TestSPLTokenDecoding:
    ...
    def _create_token_account_data(self, amount: int = 1000000000, state: int = 1) -> bytes:
    ...
    def test_decode_spl_token_mint_basic(self):
        data = self._create_token_mint_data(supply=1000000000, decimals=9)
    ...
    def test_decode_spl_token_mint_with_authorities(self):
        data = self._create_token_mint_data(has_mint_authority=True, has_freeze_authority=True)
